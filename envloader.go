...
func (env *envLoaderImpl) StringP(target *string, defaultValue string, variables ...string) {
	env.addEnv(&variant{ptrValue: target, defaultValue: defaultValue, isStr: true}, variables)
}

func (env *envLoaderImpl) BoolP(target *bool, defaultValue bool, variables ...string) {
	env.addEnv(&variant{ptrValue: target, defaultValue: defaultValue, isBool: true}, variables)
}

func (env *envLoaderImpl) IntP(target *int, defaultValue int, variables ...string) {
	env.addEnv(&variant{ptrValue: target, defaultValue: defaultValue}, variables)
}
